...
GEN_PROTO := spacex_api/common/status/status.proto spacex_api/device/account_shard.proto spacex_api/device/command.proto spacex_api/device/common.proto spacex_api/device/device.proto spacex_api/device/dish_config.proto spacex_api/device/dish.proto spacex_api/device/gnss.proto spacex_api/device/rssi_scan.proto spacex_api/device/services/unlock/service.proto spacex_api/device/transceiver.proto spacex_api/device/wifi_config.proto spacex_api/device/wifi_util.proto spacex_api/device/wifi.proto spacex_api/satellites/network/ut_disablement_codes.proto spacex_api/telemetron/public/common/time.proto spacex_api/telemetron/public/integrations/rate_limit_reason.proto
