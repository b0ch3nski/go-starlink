...
GEN_PROTO := spacex/api/device/device.proto spacex/api/common/status/status.proto spacex/api/device/command.proto spacex/api/device/common.proto spacex/api/device/dish.proto spacex/api/device/dish_config.proto spacex/api/device/wifi.proto spacex/api/device/wifi_config.proto spacex/api/device/wifi_util.proto spacex/api/device/transceiver.proto spacex/api/satellites/network/ut_disablement_codes.proto spacex/api/telemetron/public/common/time.proto
GEN_MODEL_DIR := model
