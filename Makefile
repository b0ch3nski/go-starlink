...
GEN_PROTO := spacex/api/common/status/status.proto spacex/api/device/command.proto spacex/api/device/common.proto spacex/api/device/device.proto spacex/api/device/dish_config.proto spacex/api/device/dish.proto spacex/api/device/rssi_scan.proto spacex/api/device/services/unlock/service.proto spacex/api/device/transceiver.proto spacex/api/device/wifi_config.proto spacex/api/device/wifi_util.proto spacex/api/device/wifi.proto spacex/api/satellites/network/ut_disablement_codes.proto spacex/api/telemetron/public/common/time.proto spacex/api/telemetron/public/integrations/ut_pop_link_report.proto
...
generate: ## Genertes Golang code based on GRPC reflection from Dishy
	...
	--go_opt="Mspacex/api/telemetron/public/integrations/ut_pop_link_report.proto=spacex.com/api/integrations" \
	--go-grpc_opt="Mspacex/api/telemetron/public/integrations/ut_pop_link_report.proto=spacex.com/api/integrations" \
	$(GEN_PROTO)
