...
func (c *deviceClient) Stream(ctx context.Context, opts ...grpc.CallOption) (Device_StreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Device_ServiceDesc.Streams[0], Device_Stream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *deviceClient) Handle(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, Device_Handle_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
