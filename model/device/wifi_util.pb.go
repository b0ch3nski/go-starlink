...
var file_spacex_api_device_wifi_util_proto_rawDesc = []byte{
	...
	0x4f, 0x4c, 0x54, 0x41, 0x47, 0x45, 0x10, 0x04, 0x42, 0x17, 0x5a, 0x15, 0x73, 0x70, 0x61, 0x63,
...
var file_spacex_api_device_wifi_util_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
...
var file_spacex_api_device_wifi_util_proto_goTypes = []interface{}{
	...
	(*InflatedBasicServiceSet)(nil),    // 4: SpaceX.API.Device.InflatedBasicServiceSet
	(*DhcpLease)(nil),                  // 5: SpaceX.API.Device.DhcpLease
	(*DhcpServer)(nil),                 // 6: SpaceX.API.Device.DhcpServer
	(*RadiusStatsMap)(nil),             // 7: SpaceX.API.Device.RadiusStatsMap
	(*PoeStats)(nil),                   // 8: SpaceX.API.Device.PoeStats
	(*RadiusStatsMap_RadiusStats)(nil), // 9: SpaceX.API.Device.RadiusStatsMap.RadiusStats
	nil,                                // 10: SpaceX.API.Device.RadiusStatsMap.RadiusStatsEntry
}
var file_spacex_api_device_wifi_util_proto_depIdxs = []int32{
	...
	5,  // 1: SpaceX.API.Device.DhcpServer.leases:type_name -> SpaceX.API.Device.DhcpLease
	10, // 2: SpaceX.API.Device.RadiusStatsMap.radius_stats:type_name -> SpaceX.API.Device.RadiusStatsMap.RadiusStatsEntry
	2,  // 3: SpaceX.API.Device.PoeStats.poe_state:type_name -> SpaceX.API.Device.PoeState
	9,  // 4: SpaceX.API.Device.RadiusStatsMap.RadiusStatsEntry.value:type_name -> SpaceX.API.Device.RadiusStatsMap.RadiusStats
